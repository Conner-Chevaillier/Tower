...
class App extends Component {
   ...
   handleQuoteLogin = () => {
      ...
      fetch(`http://localhost:3001/quotes/${this.state.email}`)
         ...
         .then((response) => this.setState(prevState => ({ this.state.listOfSavedQuote: [...prevState.listOfSavedQuote, { body: response.quote, author: response.author }] }))
   console.log("favs")
}
onEmailChange = (e) => {
         ...
         <div>
            ...
            <section className='quote-box'>
               ...
               <div className='quote-wrapper'>
                  ...
                  <h1 className='quote'>{this.state.listOfSavedQuote[0].body}</h1>
                  <div className='author'>{this.state.listOfSavedQuote[0].author}</div>
               </div>
               <Router>
                  <div>
