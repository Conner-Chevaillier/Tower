      ...
      return (
         ...
         <div>
            <div>
               ...
               <button onClick={this.handleQuoteLogin} type='button' name='login'>login</button>
            </div>
            <section className='quote-box'>
               ...
               <div className='btn-wrap'>
                  <button type='button' name='getQuote' className='new-quote' onClick={this.fetchNewQuote}>Get New Quote</button>
               </div>
            </section>
         </div>
         //</form>
